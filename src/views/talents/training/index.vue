<template>
  <div class="app-container">
    ...
    >
      ...
      <div slot="subPages" slot-scope="scope" v-if="scope.data.trainingId">
        ...
        <div class="sub-page">
          ...
          <div class="sub-page-body">
            <training-member sub-page-mode :forceQueryOrAddData="{trainingId: scope.data.trainingId}"
                             :trainingId="scope.data.trainingId" use-custom-add-view/>
          </div>
        </div>
      </div>
    </curdTale>
...
<script>
  ...
  import trainingMember from './trainingMember'

  export default {
    name: 'Training',
    components: {
      curdTale, trainingMember
    },
    props: {
      selectMode: {
        type: Boolean,
    ...
    methods: {
      ...
      del(info, queryDataInfo) {
        delInfo({ id: info.trainingId }).then(response => {
      ...
      detail(info) {
        getDetailInfo({ id: info.trainingId }).then(response => {
