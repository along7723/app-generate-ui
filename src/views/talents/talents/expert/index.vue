  ...
  export default {
    ...
    methods: {
      ...
      edit(info, noRefresh, queryDataInfo) {
        console.log('noRefresh', noRefresh)
        console.log('queryDataInfo', queryDataInfo)
      ...
      del(info, queryDataInfo) {
        delInfo({ id: info.expertId }).then(response => {
      ...
      detail(info) {
        getDetailInfo({ id: info.expertId }).then(response => {
