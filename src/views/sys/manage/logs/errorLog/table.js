const tableInfo = {
  ...
  keyField: 'id',
  editInTable: false,
  fastQueryFields: 'ip, token',
  fastQueryTips: 'ip地址, 登录凭证',
  defaultSortField: 'create_time',
  defaultSortType: 'desc',
  permissions: {
    add: { button: '/errorLog/add' },
    del: { button: '/errorLog/del' },
    edit: { button: '/errorLog/update' },
    detail: { button: '/errorLog/getById' }
  }
